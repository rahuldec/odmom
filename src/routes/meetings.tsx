...
function ListPage() {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      setEmailTo([]);
      setEmailCc(["customer-success-delight@okiedokiepay.com"]);
    } catch (e) {
  ...
  return (
    <AppShell>
      ...
      {/* Email dialog */}
      <Dialog open={!!emailMomId} onOpenChange={(o) => { if (!o) { setEmailMomId(null); setEmailTo([]); setEmailInput(""); setEmailCc(["customer-success-delight@okiedokiepay.com"]); setEmailCcInput(""); } }}>
        <DialogContent className="max-w-lg bg-white text-gray-900">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-1">
              <Button variant="outline" className="border-gray-200 bg-white text-gray-700 hover:bg-gray-50" onClick={() => { setEmailMomId(null); setEmailTo([]); setEmailInput(""); setEmailCc(["customer-success-delight@okiedokiepay.com"]); setEmailCcInput(""); }} disabled={emailSending}>
                Cancel
              </Button>
